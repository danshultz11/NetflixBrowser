(function () {
    ...
    function fragmentLoad(elements, options) {
        ...
        elements.querySelector('.pageTitle').textContent = item.Name;

        WinJS.UI.processAll(elements)
            .then(function () {
            elements.querySelector('.title').textContent = item.Name;
            elements.querySelector('.content').innerHTML = item.Synopsis;
        });
    }
